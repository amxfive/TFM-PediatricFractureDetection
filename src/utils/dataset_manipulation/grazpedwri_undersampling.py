...
DEST_BASE = 'data/raw/GRAZ_SAMPLED_TEST'

# Definición de repartos (Imágenes finales deseadas)
# Para TRAIN aplicamos el equilibrio que hablamos
CONFIG = {
    'train': {'target_pos': 900, 'target_neg': 100}, # Total 1800
    'valid':   {'target_pos': 80,  'target_neg': 20},  # Val pequeño y rápido
    'test':  {'target_pos': 80,  'target_neg': 20}  # Test equilibrado
}
